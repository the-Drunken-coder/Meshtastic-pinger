...
from meshtastic_pinger.message_sink import _append_line, _build_handler, _extract_message_text, run_sink
...
def test_run_sink_listens_and_logs_packets(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("meshtastic_pinger.message_sink.auto_detect_radio_port", fake_auto_detect)
